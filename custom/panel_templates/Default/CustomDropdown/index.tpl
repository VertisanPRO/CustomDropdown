            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="content">
                        ...
                        {/if}
                        <div class="float-md">
                            <button class="btn btn-primary" type="button" onclick="showAddModal()">{$ADD_NEW_DROPDOWN}
                                                ...
                                                <td>
                                                    <div class="float-md-right">
                                                        ...
                                                        {if $dropdown.enabled == 1}
                                                            <a class="btn btn-success btn-sm" href="{$dropdown.enabled_link}"><i
                                                                    class="fa fa-toggle-on" aria-hidden="true"></i></a>
                                                        {else}
                                                            <a class="btn btn-danger btn-sm" href="{$dropdown.enabled_link}"><i
                                                                    class="fa fa-toggle-off" aria-hidden="true"></i></a>
                                                        {/if}
                                                        <a class="btn btn-primary btn-sm" title="{$SETTINGS}"
